        ...
        <div className={`${isDarkTheme ? 'darkTheme' : 'lightTheme'} ${'container'}`}>
            ...
            <section id="start" className={`${style_guides.guide} ${inter.className}`}>
                <div className={style_guides.guide__header__container}>
                    {_(language, "quick-start-1")} <span>{_(language, "quick-start-2")}</span>
                </div>
                <ul className={style_guides.guide__main}>
                    <li className={style_guides.guide__main__item}>
                        <div className={style_guides.guide__main__item__text__container}>
                            ...
                            <div className={style_guides.guide__main__item__container}>
                                <div
                                    className={style_guides.guide__main__item__container__title}>{_(language, "auth-app")}
                                </div>
                                <ol className={style_guides.guide__main__item__container__list}>
                                    <li className={style_guides.guide__main__item__container__list__item}>
                                        {_(language, "open-cb-1")} <span
                                        className={style_guides.guide__b}>{_(language, "open-cb-2")}</span>
                                    </li>
                                    <li className={style_guides.guide__main__item__container__list__item}>
                                        {_(language, "go-to-cp")} <span
                                        className={style_guides.guide__b}>{_(language, "go-to-cp-2")}</span>
                                    </li>
                                    <li className={style_guides.guide__main__item__container__list__item}>
                                        {_(language, "tap-create-app")} <span
                                        className={style_guides.guide__bb}>{_(language, "tap-create-app-2")}</span>
                                    </li>
                                    <li className={style_guides.guide__main__item__container__list__item}>
                                        {_(language, "get-api-token-1")} <span
                                        className={style_guides.guide__b}>{_(language, "get-api-token-2")}</span>
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <li className={style_guides.guide__main__item}>
                        ...
                        <div className={style_guides.guide__main__item__text__container}>
                            ...
                            <div className={style_guides.guide__main__item__container}>
                                <div
                                    className={style_guides.guide__main__item__container__title}>{_(language, "api-request")}
                                </div>
                                <p className={style_guides.guide__main__item__container__description}>{_(language, "https-only")}</p>
                                <p className={style_guides.guide__main__item__container__description}>{_(language, "pass-params")}</p>
                    ...
                    <li className={style_guides.guide__main__item}>
                        ...
                        <div className={style_guides.guide__main__item__text__container}>
                            ...
                            <div className={style_guides.guide__main__item__container}>
                                <div
                                    className={style_guides.guide__main__item__container__title}>{_(language, "getting-updates")}</div>
                                <p className={style_guides.guide__main__item__container__description}>{_(language, "two-ways")}</p>
                                <p className={style_guides.guide__main__item__container__description}>{_(language, "updates-for")}</p>
                                <ul className={style_guides.guide__main__item__container__list__ul}>
                                    <li className={style_guides.guide__main__item__container__list__item}>
                                        <span
                                            className={style_guides.guide__b}>getInvoices </span>{_(language, "get-a-list")}
                                    </li>
                                    <li className={style_guides.guide__main__item__container__list__item}>
                                        <span
                                            className={style_guides.guide__b}>Webhooks </span>{_(language, "to-receive")}
                                        realtime.
                                    </li>
                                </ul>
                            </div>
            ...
            <section className={`${style_baner.baner} ${inter.className}`}>
                <div className={style_baner.baner__container}>
                    <div className={style_baner.baner__container__text}>
                        <div className={style_baner.baner__container__text__title}>{_(language, "cp-api")}</div>
                        <p className={style_baner.baner__container__text__description}>{_(language, "explore-methods")}</p>
                        <button
                            className={style_baner.baner__container__text__button}>{_(language, "open-api-docs")}</button>
                    </div>
            ...
            <section className={`${style_join.join} ${inter.className}`}>
                <div className={style_join.wrapper__join__dev}>
                    <div className={style_join.section__join__dev__title}>{_(language, "join_dev")}</div>

                    <div className={style_join.section__join__dev__subtitle}>
                        {_(language, "connect-with-devs")}
                    </div>
            ...
            <footer className={`${footer_styles.footer} ${inter.className}`}>
                <div className={footer_styles.footer__line}>
                    ...
                    <div className={footer_styles.footer__button}>
                        <a href="www.google.com">{_(language, "get-started")}</a>
                    </div>
                </div>

                <div className={footer_styles.footer__copyright}>{_(language, "copyright")}</div>
